...
var RcsbPdbMCP = class extends McpAgent {
  constructor() {
    ...
    this.server = new McpServer({
      ...
      version: "0.1.0",
      description: `MCP Server for querying the RCSB Protein Data Bank (PDB) GraphQL API.
...
Refer to the RCSB PDB Data API documentation and the GraphiQL tool (available at the API endpoint) for further schema exploration and query examples. If a query fails, always consider using introspection to verify field names and types before retrying.`,
    ...
    this.RCSB_PDB_GRAPHQL_ENDPOINT = "https://data.rcsb.org/graphql";
  }
  static {
...
// .wrangler/tmp/bundle-Ka4frH/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ka4frH/middleware-loader.entry.ts
