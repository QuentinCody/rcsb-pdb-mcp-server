...
var SchemaInferenceEngine_exports = {};
__export(SchemaInferenceEngine_exports, {
  SchemaInferenceEngine: () => SchemaInferenceEngine
});
var SchemaInferenceEngine;
var init_SchemaInferenceEngine = __esm({
  "src/lib/SchemaInferenceEngine.ts"() {
    "use strict";
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
    ...
    SchemaInferenceEngine = class {
      ...
      // Now tracks unique relationships only
      inferFromJSON(data) {
      ...
      discoverEntities(obj, path, parentEntityType) {
            ...
            for (const item of obj) {
              if (this.isEntity(item)) {
                ...
                if (parentEntityType && path.length > 0) {
                  ...
                  if (fieldName !== "nodes" && fieldName !== "edges") {
      ...
      isEntity(obj) {
        ...
        const hasId = obj.id !== void 0 || obj._id !== void 0 || obj.rcsb_id !== void 0;
        const fieldCount = Object.keys(obj).length;
        const hasMultipleFields = fieldCount >= 2;
        const hasEntityFields = obj.name !== void 0 || obj.title !== void 0 || obj.description !== void 0 || obj.type !== void 0 || obj.entry_id !== void 0 || obj.entity_id !== void 0 || obj.assembly_id !== void 0 || obj.comp_id !== void 0;
      ...
      resolveColumnTypes(columnTypes) {
        const columns = {};
...
var DataInsertionEngine_exports = {};
__export(DataInsertionEngine_exports, {
  DataInsertionEngine: () => DataInsertionEngine
});
var DataInsertionEngine;
var init_DataInsertionEngine = __esm({
  "src/lib/DataInsertionEngine.ts"() {
    "use strict";
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
    ...
    DataInsertionEngine = class {
      ...
      // Track actual relationships found in data
        ...
        for (const columnName of Object.keys(schema.columns)) {
          ...
          if (columnName.endsWith("_id") && !columnName.includes("_json")) {
            ...
            if (originalKey && obj[originalKey] && typeof obj[originalKey] === "object") {
              value = obj[originalKey].id || obj[originalKey].rcsb_id || null;
            }
      ...
      findOriginalKey(obj, sanitizedKey) {
        ...
        return keys.find(
          (key) => this.sanitizeColumnName(key) === sanitizedKey
        ) || null;
      }
      sanitizeColumnName(name) {
        if (!name || typeof name !== "string") {
      ...
      async insertSimpleRow(obj, tableName, schema, sql) {
        ...
        if (Object.keys(rowData).length === 0 && !(tableName === "scalar_data" && obj === null)) return;
        const columns = Object.keys(rowData);
        const placeholders = columns.map(() => "?").join(", ");
        const values = Object.values(rowData);
      ...
      mapObjectToSimpleSchema(obj, schema) {
        const rowData = {};
        if (obj === null || typeof obj !== "object") {
...
var PaginationAnalyzer_exports = {};
__export(PaginationAnalyzer_exports, {
  PaginationAnalyzer: () => PaginationAnalyzer
});
var PaginationAnalyzer;
var init_PaginationAnalyzer = __esm({
  "src/lib/PaginationAnalyzer.ts"() {
    "use strict";
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
...
// .wrangler/tmp/bundle-o1gwiu/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-o1gwiu/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
init_SchemaInferenceEngine();
init_DataInsertionEngine();
init_PaginationAnalyzer();
...
var JsonToSqlDO = class extends DurableObject3 {
  ...
  async processAndStoreJson(jsonData) {
    try {
      ...
      return {
        success: false,
        message: error3 instanceof Error ? error3.message : "Processing failed"
      };
    }
  }
  async executeSql(sqlQuery) {
    try {
      ...
      return {
        success: false,
        error: error3 instanceof Error ? error3.message : "SQL execution failed",
        query: sqlQuery
      };
    }
  }
  ...
  async createTables(schemas) {
    for (const [tableName, schema] of Object.entries(schemas)) {
      try {
        ...
        console.error(`Error creating table ${tableName}:`, error3);
        try {
  ...
  async generateMetadata(schemas) {
    const metadata = {
      schemas: {},
...
Example data query: '{ entry(entry_id:"4HHB") { struct { title } exptl { method } } }'.`
  ...
  async processAndStoreJson(jsonData) {
    try {
      let dataToProcess = jsonData?.data ? jsonData.data : jsonData;
      const { PaginationAnalyzer: PaginationAnalyzer2 } = await Promise.resolve().then(() => (init_PaginationAnalyzer(), PaginationAnalyzer_exports));
      const paginationInfo = PaginationAnalyzer2.extractInfo(dataToProcess);
      const { SchemaInferenceEngine: SchemaInferenceEngine2 } = await Promise.resolve().then(() => (init_SchemaInferenceEngine(), SchemaInferenceEngine_exports));
      const schemaEngine = new SchemaInferenceEngine2();
      const schemas = schemaEngine.inferFromJSON(dataToProcess);
      await this.createTables(schemas);
      const { DataInsertionEngine: DataInsertionEngine2 } = await Promise.resolve().then(() => (init_DataInsertionEngine(), DataInsertionEngine_exports));
      const dataInsertionEngine = new DataInsertionEngine2();
      await dataInsertionEngine.insertData(dataToProcess, schemas, this.ctx.storage.sql);
      const metadata = await this.generateMetadata(schemas);
      if (paginationInfo.hasNextPage) {
        metadata.pagination = paginationInfo;
  ...
  async generateMetadata(schemas) {
    ...
    for (const tableName of Object.keys(schemas)) {
      try {
        ...
        const count3 = countResult.toArray()[0]?.count || 0;
        metadata.total_rows += count3;
        metadata.tables[tableName] = {
          row_count: count3,
          columns: Object.keys(schemas[tableName].columns || {})
        };
      } catch (error3) {
        console.error(`Error getting metadata for table ${tableName}:`, error3);
        metadata.tables[tableName] = {
          row_count: 0,
          columns: [],
...
var src_default = {
  async fetch(request, env2, ctx) {
    ...
    if (url.pathname === "/sse" || url.pathname.startsWith("/sse/")) {
      return RcsbPdbMCP.serveSSE("/sse", { binding: "JSON_TO_SQL_DO" }).fetch(request, env2, ctx);
    }
